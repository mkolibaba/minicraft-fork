...
public class Font {
	...
	public static void renderFrame(Screen screen, String title, int x0, int y0, int x1, int y1) {
		for (int y = y0; y <= y1; y++) {
			for (int x = x0; x <= x1; x++) {
				if (x == x0 && y == y0)
					screen.render(x * 8, y * 8, 0 + 13 * 32, Color.DARK_BLUE, 0);
				else if (x == x1 && y == y0)
					screen.render(x * 8, y * 8, 0 + 13 * 32, Color.DARK_BLUE, 1);
				else if (x == x0 && y == y1)
					screen.render(x * 8, y * 8, 0 + 13 * 32, Color.DARK_BLUE, 2);
				else if (x == x1 && y == y1)
					screen.render(x * 8, y * 8, 0 + 13 * 32, Color.DARK_BLUE, 3);
				else if (y == y0)
					screen.render(x * 8, y * 8, 1 + 13 * 32, Color.DARK_BLUE, 0);
				else if (y == y1)
					screen.render(x * 8, y * 8, 1 + 13 * 32, Color.DARK_BLUE, 2);
				else if (x == x0)
					screen.render(x * 8, y * 8, 2 + 13 * 32, Color.DARK_BLUE, 0);
				else if (x == x1)
