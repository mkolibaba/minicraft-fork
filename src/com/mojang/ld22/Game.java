...
public class Game extends Canvas implements Runnable {
	...
	private void renderFocusNagger() {
		...
		screen.render(xx - 8, yy - 8, 0 + 13 * 32, Color.DARK_BLUE, 0);
		screen.render(xx + w * 8, yy - 8, 0 + 13 * 32, Color.DARK_BLUE, 1);
		screen.render(xx - 8, yy + 8, 0 + 13 * 32, Color.DARK_BLUE, 2);
		screen.render(xx + w * 8, yy + 8, 0 + 13 * 32, Color.DARK_BLUE, 3);
		for (int x = 0; x < w; x++) {
			screen.render(xx + x * 8, yy - 8, 1 + 13 * 32, Color.DARK_BLUE, 0);
			screen.render(xx + x * 8, yy + 8, 1 + 13 * 32, Color.DARK_BLUE, 2);
		}
		for (int y = 0; y < h; y++) {
			screen.render(xx - 8, yy + y * 8, 2 + 13 * 32, Color.DARK_BLUE, 0);
			screen.render(xx + w * 8, yy + y * 8, 2 + 13 * 32, Color.DARK_BLUE, 1);
		}
